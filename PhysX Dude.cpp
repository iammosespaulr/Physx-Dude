...
null_resp.addresp("HOW I AM SUPPOSED TO TALK TO YOU ,IF YOU DON'T SAY ANYTHING ?");

// upon  logging in
resp signon;
signon.addresp("HI, I'M PhysX Dude. What's Up ?");
signon.addresp("HELLO, WHAT'S NEW ABOUT TODAY?");
...
// welcoming the user
Moses.speak("Welcome ,to ,Physx ,Dude ,A ,Chat ,Bot ,Programmed By Moses Paul");
cout<<"PhysX Dude > WHAT'S YOUR NAME NERD ?(PLS TYPE IN CAPS)\n";
cin>>user;
cout<<"HI "<<user<<" PLS WAIT WHILE PROGRAM INITIALISES \n";
display_line();
display_line();
